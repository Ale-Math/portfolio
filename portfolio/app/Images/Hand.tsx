export function HandSvg() {
  return (
    <svg
      ...
      className="enable-background:new 0 0 47.5 47.5 size-10"
      fill="gold"
    ...
    >
      ...
      <g transform="matrix(1.25 0 0 -1.25 0 47.5)">
        <path
          ...
          className="fill:#d99e82;fill-opacity:1;fill-rule:nonzero;stroke:none"
          transform="translate(34.305 19.664)"
        ></path>
        <path
          d="M0 0h-2a6.966 6.966 0 0 0 6.958 6.958v-2A4.964 4.964 0 0 1 0 0"
          className="fill:#77b255;fill-opacity:1;fill-rule:nonzero;stroke:none"
